  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Visão geral das vistorias e pendências em aberto.
          </p>
        </div>
        <Button
          variant="outline"
      ...
      <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
        <StatCard label="Achados em aberto" value={totalAbertos} accent />
        <StatCard label="Vistorias 7 dias" value={totalVistoriasSemana} />
        <StatCard label="Empreendimentos" value={totalEmp} />
        <StatCard label="Unidades" value={totalUnid} />
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <section className="space-y-3">
          ...
          {tempoMedioPorCategoria.length === 0 ? (
            <div className="rounded-lg border bg-muted/30 p-6 text-sm text-center text-muted-foreground">
              Nenhum achado resolvido ainda.
            </div>
          ) : (
